...
// NUEVO: obtener setting específico de usuario
async function getUserSetting(userId, key) {
  const user = await getUser(userId);
  return user[key];
}

// NUEVO: cambiar setting específico de usuario
...
// obtener setting específico del grupo
async function getGroupSetting(groupId, key) {
  const group = await getGroup(groupId);
  return group[key];
}

// cambiar setting específico del grupo
