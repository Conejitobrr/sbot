...
async function onMessage(ctx) {
  const { sock, remoteJid, body, sender, pushName, fromGroup, msg } = ctx;

  // ❌ FIX IMPORTANTE: se eliminó audios directo (causaba el fallo)
  // ahora audios se maneja SOLO desde handler.js
